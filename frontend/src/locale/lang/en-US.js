export default {
  ...
  level_2: 'level-2',
  level_2_1: 'level-2-1',
  ajax_error: 'System error',
  login_incorrect: 'Sorry,wrong password,please login again.',
  info: 'info',
  login_timeout: 'Sorry,Your login has expired,or you have no permission.please try login again.',
  login_out: 'LoginOut',
  home: 'home'
}
